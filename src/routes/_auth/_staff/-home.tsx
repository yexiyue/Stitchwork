...
export function StaffHome() {
  ...
  const handleRefresh = async () => {
    ...
    await queryClient.invalidateQueries({ queryKey: ["staff-stats-by-order"] });
  };
      ...
      series: [
        {
          ...
          label: { show: true, position: "top", fontSize: 9, formatter: `{c}${pieceUnit}` },
        },
      ],
    };
  }, [byOrder, pieceUnit]);
